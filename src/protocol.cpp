...
static unsigned char pchMessageStartPEX[4] = { 0xa3, 0xb3, 0xc2, 0xd3 };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartPEX : pchMessageStartBitcoin, sizeof(pchMessageStartPEX));
}
