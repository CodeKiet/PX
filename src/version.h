...
#define PEX_VERSION_MAJOR       3
#define PEX_VERSION_MINOR       0
#define PEX_VERSION_REVISION    0
#define PEX_VERSION_BUILD       0

static const int PEX_VERSION =
                           1000000 * PEX_VERSION_MAJOR
                         +   10000 * PEX_VERSION_MINOR
                         +     100 * PEX_VERSION_REVISION
                         +       1 * PEX_VERSION_BUILD;
